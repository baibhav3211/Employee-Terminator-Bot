...
import { EmojiPeopleOutlined, History, Home, RocketLaunch} from '@mui/icons-material';
...
const listItems = [
    {
        ...
        "icon": <Home />,
        "link": "/admindashboard",
        "userType": "admin" // Displayed for admin
    },
    {
        "name": "Initiate Process",
        "icon": <RocketLaunch />,
        "link": "/admindashboard/termination",
        "userType": "admin" // Displayed for users
      },
    {
        "name": "View History",
        "icon": <History />,
        "link": "/admindashboard/history",
        "userType": "admin" // Displayed for admins
    },
    {
        "name": "View Employees",
